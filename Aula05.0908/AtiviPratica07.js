...
Objetivo:
Praticar a manipulação de arrays utilizando métodos avançados, como filter, map e
=======
/* Atividade 07
Crie um programa que faça o seguinte:
...
reduce, para realizar operações complexas de transformação e agregação de dados. */